all: check-and-reinit-submodules modules/cyperus-server/build/cyperus-server env/pyvenv/bin/activate modules/pycyperus/pycyperus.egg-info
...
modules/pycyperus/pycyperus.egg-info: env/pyvenv/bin/activate check-and-reinit-submodules
