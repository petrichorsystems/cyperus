all: check-and-reinit-submodules modules/cyperus-server/build/cyperus-server modules/pycyperus/pycyperus.egg-info
...
modules/pycyperus/pycyperus.egg-info: env/pyvenv/bin/activate
